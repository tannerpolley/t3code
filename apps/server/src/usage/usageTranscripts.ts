...
/** Whether a Codex session metadata payload marks a fork or native subagent. */
export function isCodexWorkerSessionMeta(payload: Record<string, unknown>): boolean {
...
export function parseCodexLine(line: string, state: CodexScanState): UsageRecord | null {
  ...
  if (record["type"] === "session_meta") {
    ...
    if (metaTimestampMs !== null && isCodexWorkerSessionMeta(payloadRecord)) {
